...
def run_chat_eval(task_name, model, tokenizer, engine,
    ...
    task_module = {
        ...
        'AIME-2025': partial(AIME, year=25, split="test"),
        'AIME-2024': partial(AIME, year=24, split="test"),
    }[task_name]
...
if __name__ == "__main__":
    ...
    all_tasks = ['ARC-Easy', 'ARC-Challenge', 'MMLU', 'GSM8K', 'HumanEval', 'SpellingBee', 'AIME-2024', 'AIME-2025']
    baseline_accuracies = {
        ...
        'AIME-2024': 0.0, # open-ended => 0%
        'AIME-2025': 0.0, # open-ended => 0%
    }
