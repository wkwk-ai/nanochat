...
parser.add_argument("--total-batch-size", type=int, default=131072, help="total batch size in tokens")
...
parser.add_argument("--eval-tokens", type=int, default=20*131072, help="number of tokens to evaluate val loss on")
